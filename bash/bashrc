...
# alias
source $HOME/dotfiles/bash/alias.bash

# export
source $HOME/dotfiles/bash/env.bash

# color for man pages
source $HOME/dotfiles/bash/man.bash

# bash-it
source $HOME/dotfiles/bash/bash_it.bash
...
# completion
source $HOME/dotfiles/bash/completion.bash
